...
exports.parseDATUMTemplateCreator = exports.getVarIntLength = exports.parseMultisigScript = exports.opcodes = void 0;
const opcodes = {
    OP_FALSE: 0,
    OP_0: 0,
    OP_PUSHDATA1: 76,
...
exports.parseMultisigScript = parseMultisigScript;
function getVarIntLength(n) {
    if (n < 0xfd) {
        return 1;
    }
    else if (n <= 0xffff) {
...
exports.parseDATUMTemplateCreator = parseDATUMTemplateCreator;
