...
class Icons {
    static FILE_NAME = '/elements/asset_registry_db/icons.json';
    iconIds = [];
    icons = {};
    constructor() { }
    loadIcons() {
        if (!fs.existsSync(Icons.FILE_NAME)) {
            logger_1.default.warn(`${Icons.FILE_NAME} does not exist. No Liquid icons loaded.`);
            return;
        }
        ...
        logger_1.default.debug(`Liquid icons has been loaded.`);
    }
    getIconByAssetId(assetId) {
