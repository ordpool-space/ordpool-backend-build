...
class StatisticsApi {
    ...
    async $createZeroedStatistic() {
        try {
            ...
            logger_1.default.err('$create() error' + (e instanceof Error ? e.message : e));
        }
    }
    async $create(statistics, convertToDatetime = false) {
        try {
            const query = `INSERT INTO statistics(
              added,
              unconfirmed_transactions,
    ...
    getQueryForDaysAvg(div, interval) {
        return `SELECT
    ...
    async $get(id) {
        try {
            ...
            logger_1.default.err('$list2H() error' + (e instanceof Error ? e.message : e));
        }
    }
    async $list2H() {
        try {
    ...
    async $list24H() {
        try {
            ...
            logger_1.default.err('$list24h() error' + (e instanceof Error ? e.message : e));
            return [];
        }
    }
    async $list1W() {
        try {
            ...
            logger_1.default.err('$list1W() error' + (e instanceof Error ? e.message : e));
            return [];
        }
    }
    async $list1M() {
        try {
            ...
            logger_1.default.err('$list1M() error' + (e instanceof Error ? e.message : e));
            return [];
        }
    }
    async $list3M() {
        try {
            ...
            logger_1.default.err('$list3M() error' + (e instanceof Error ? e.message : e));
            return [];
        }
    }
    async $list6M() {
        try {
            ...
            logger_1.default.err('$list6M() error' + (e instanceof Error ? e.message : e));
            return [];
        }
    }
    async $list1Y() {
        try {
            ...
            logger_1.default.err('$list1Y() error' + (e instanceof Error ? e.message : e));
            return [];
        }
    }
    async $list2Y() {
        try {
            ...
            logger_1.default.err('$list2Y() error' + (e instanceof Error ? e.message : e));
            return [];
        }
    }
    async $list3Y() {
        try {
            ...
            logger_1.default.err('$list3Y() error' + (e instanceof Error ? e.message : e));
            return [];
        }
    }
    async $list4Y() {
        try {
            ...
            logger_1.default.err('$list4Y() error' + (e instanceof Error ? e.message : e));
            return [];
        }
    }
    async $listAll() {
        try {
            ...
            logger_1.default.err('$listAll() error' + (e instanceof Error ? e.message : e));
            return [];
        }
    }
    ...
    mapOptimizedStatisticToStatistic(statistic) {
        return statistic.map((s) => {
