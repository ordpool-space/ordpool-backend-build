...
exports.SingleFlightCache = void 0;
...
class SingleFlightCache {
    ...
    startRefresh(key, compute) {
        ...
        promise.catch((e) => {
            logger_1.default.err(`Cannot refresh ${this.label} (${key}). Reason: ` + (e instanceof Error ? e.message : e));
        });
        return promise;
    }
...
exports.SingleFlightCache = SingleFlightCache;
