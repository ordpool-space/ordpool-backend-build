...
const ordpool_parser_flag_version_1 = require("./ordpool-parser-flag-version");
...
const ORDPOOL_BLOCK_SUMMARY_VERSION = ordpool_parser_flag_version_1.ORDPOOL_PARSER_FLAG_GENERATION;
class Blocks {
    blocks = [];
    blockSummaries = [];
